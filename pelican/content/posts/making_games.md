...
I finally got around to learning Godot about 12 months ago. **THIS** was what I've been missing in my life. Game engines weren't a thing when I was a kid and animating stick figures was all I could muster at the time. I started out building several small games from a Udemy course ([one of which](https://jaerrib.itch.io/photon-frenzy) I expanded and released), but I've also created an original game called *Wightwatch Keep*. It's [open-source](https://codeberg.org/jaerrib/wightwatch_keep) but also available on [Itch.io](https://jaerrib.itch.io/wightwatch-keep).
