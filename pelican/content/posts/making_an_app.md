...
Many people who play solo TTRPGs (tabletop role play games) have books, paper, and dice: basically everything as non-electronic as possible. Others use PDF sourcebooks and keep notes using some sort of app. I got the idea to make a dice-rolling application for that latter group.
